...
public class AircraftController : MonoBehaviour
{
    ...
    {
        Vector3 vector = new Vector3((float)c.X / 15000,
    ...
    {
        IList<Coordinate> track = _flightData.Track.ToArray();
...

        {
            ...
            var pLast = track[tracksize - 1];

            var pSecondLast = track[tracksize - 3];
